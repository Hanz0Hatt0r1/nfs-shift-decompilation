...
def def test_runtime_golden_gate_rejects_shader_and_material_range_on_different_draws(tmp_path):
    ...
    runtime['frames'][0]['draws'] = [
        ...
        {'start_index': 0, 'primitive_count': 1, 'base_vertex_index': 0},
    ]
    base_snapshot = {
        'frame': 1,
        'vertex_declaration': {'declaration_ptr': '0x1', 'resource_sha256': 'sha', 'create_known': True},
    ...
    runtime['frames'][0]['draw_snapshots'] = [
        {
            **base_snapshot,
            ...
            'shader_permutation_identity': {'identity_sha256': 'wrong-shader', 'payload': {'vertex': {'inputs': [{'register': 'v0', 'usage': 'COLOR', 'index': 0}], 'constants': []}, 'pixel': {'constants': [5], 'sampler_types': {}}}},
        },
        {
            **base_snapshot,
            'draw_index': 1,
