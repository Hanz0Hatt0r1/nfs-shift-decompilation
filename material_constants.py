...
It only packs proven float/vector constants into 16-byte c-register slots;
...
def pack_material_constant_payload(uniform_binding: dict[str, Any]) -> dict[str, Any]:
    ...
    for binding in uniform_binding.get("bindings", []) or []:
        ...
        register_set = binding.get("register_set")
        try:
        ...
        # Only vector/scalar CTAB shapes are packed here. Matrices deliberately
        # remain blocked until their exact register orientation is proven.
