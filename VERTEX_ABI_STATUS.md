...
Phase 102 hardening verified the sentinel producer against the uploaded source snapshot's local_14 index form; the scanner no longer depends on the synthetic pAVar22 variable name used by an earlier regression fixture.
