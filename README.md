...
> **PE-backed declaration map:** Phase 224 adds a normalized `SHIFT.D3D9PESemanticMap/1` plus runtime numeric parity validation against the exact SHIFT.exe Type/Usage tables. This strengthens declaration matching before the remaining same-instance runtime gate.
