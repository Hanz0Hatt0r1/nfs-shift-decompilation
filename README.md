...
> **Retail input manifest:** Phase 226 adds `retail_research_manifest.py` for identity-only SHA-256/size tracking of local `SHIFT.exe`, BFF and other reverse-engineering inputs. The binary/archive contents remain outside the repository.
