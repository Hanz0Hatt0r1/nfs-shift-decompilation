...
> **Unified declaration gate:** Phase 225 composes the recovered declaration chain with the exact SHIFT.exe PE Type/Usage ABI and can optionally validate runtime declaration numeric fields. Same-instance MEB→draw identity remains a separate gate.
