...
def cmd_bmw_runtime_render_contract(args: argparse.Namespace) -> int:
    """Build the fail-closed runtime BMW shader render contract."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    p = sp.add_parser("bmw-runtime-render-contract", help="build a fail-closed BMW shader render contract from runtime capture")
    p.add_argument("material_input", help="BMW material binding evidence JSON")
    p.add_argument("runtime_report", help="D3D9 runtime binding evidence JSON")
    p.add_argument("selection", help="BMW runtime shader selection JSON")
    p.add_argument("output", help="BMW runtime render contract JSON")
