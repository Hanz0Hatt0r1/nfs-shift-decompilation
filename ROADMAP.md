...
Phase 102 hardening also makes the sentinel producer scanner tolerant of decompiler-local variable renaming, so source evidence is tied to the field expressions rather than one emitted temporary name.
