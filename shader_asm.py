...
def to_glsl(program:ShaderProgram, max_lines:int=10000)->str:
    ...
    for ins in program.instructions:
        ...
        try:
            ...
            elif n=='LRP' and len(o)>=4: lines.append('  '+_assign(o[0],f'mix({_glsl_reg(o[3],program.stage)},{_glsl_reg(o[2],program.stage)},{_glsl_reg(o[1],program.stage)})'))
            elif n=='CMP' and len(o)>=4: lines.append('  '+_assign(o[0],f'mix({_glsl_reg(o[3],program.stage)},{_glsl_reg(o[2],program.stage)},greaterThanEqual({_glsl_reg(o[1],program.stage)},vec4(0.0)))'))
