...
def build_bmw_vulkan_bundle(
    ...
    *,
    ...
    report = {
        ...
        "source": {
            "render_command_format": selected.get("format"),
            "command_index": command_index,
            "submesh_index": submesh_index,
            "mesh_ref": (selected.get("mesh") or {}).get("ref"),
            "mesh_sha256": ((selected.get("mesh") or {}).get("resolved") or {}).get("resource_sha256"),
        },
        "target": {
            "meb": TARGET_MEB,
            "vertex_count": (selected.get("mesh") or {}).get("vertex_count"),
            "triangle_count": (selected.get("mesh") or {}).get("triangle_count"),
        },
        "artifacts": artifacts,
