...
def tracking_data_defaults() -> dict[str, Any]:
    ...
    writes = {
        0x00: 0x3F800000, 0x04: 0, 0x08: 0, 0x0C: 0,
        0x10: 0, 0x14: 0, 0x18: 0, 0x1C: 0,
        0x20: 0, 0x24: 0, 0x28: 0, 0x2C: 0,
        0x30: 0, 0x34: 0, 0x38: 0, 0x3C: 0,
        0x40: 0, 0x41: 0xFFFFFFFF, 0x48: 0, 0x4C: 0xFFFFFFFF,
        0x50: 0, 0x54: 0, 0x58: 0, 0x5C: 0,
        0x60: 0, 0x64: 0, 0x68: 0, 0x6C: 0,
        0x70: 0, 0x74: 0, 0x78: 0, 0x7C: 0,
        0x80: 0, 0x84: 0, 0x88: 0x3F800000,
        0x8C: 0, 0, 0x90: 0, 0x94: 0,
        0x98: 0, 0x3F800000, 0x9C: 0, 0xA0: 0,
        0xA4: 0, 0xA8: 0, 0xAC: 0, 0xB0: 0,
    }
    # C code writes byte +0x39, +0x64, but the data initializer is easiest
    # to expose as exact byte markers in addition to the raw dword footprint.
    return {
        "format": FORMAT,
        "version": 1,
